...
public class TurtleLeggings extends LegendaryItemStack {
	
	public static TurtleLeggings template = new TurtleLeggings();
	
	public TurtleLeggings() {
		super(Material.DIAMOND_LEGGINGS, (short)0);
	...
	public static void register() {
		LegendaryItemStack.registerLegendary("turtleLeggings", TurtleLeggings.class);
	}
	
	public String getDisplayName() {
		return ChatColor.GOLD + "Turtle Leggings";
	}
}
