...
public class TurtleHelmet extends LegendaryItemStack {
	
	public static TurtleHelmet template = new TurtleHelmet();
	
	public TurtleHelmet() {
		super(Material.DIAMOND_HELMET, (short)0);
	...
	public static void register() {
		LegendaryItemStack.registerLegendary("turtleHelmet", TurtleHelmet.class);
	}
	
	public String getDisplayName() {
		return ChatColor.GOLD + "Turtle Helmet";
	}
}
