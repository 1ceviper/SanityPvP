...
public class TurtleBoots extends LegendaryItemStack {
	
	public static TurtleBoots template = new TurtleBoots();
	
	public TurtleBoots() {
		super(Material.DIAMOND_BOOTS, (short)0);
	...
	public static void register() {
		LegendaryItemStack.registerLegendary("turtleBoots", TurtleBoots.class);
	}
	
	public String getDisplayName() {
		return ChatColor.GOLD + "Turtle Boots";
	}
}
